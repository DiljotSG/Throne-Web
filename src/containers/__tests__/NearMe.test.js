...
fetchMock.get('https://testapi.com/washrooms?max_results=1000&radius=5000&amenities=', washrooms);
fetchMock.get('https://testapi.com/buildings?max_results=1000&radius=5000&amenities=', buildings);
